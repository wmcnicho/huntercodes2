            ...
            <Box pt={12}>
                <Grid container spacing={2} p={3}>
                    ...
                    <Grid item md={7} xs={12} sx={{textAlign:'left'}}>
                        ...
                        <Typography>I'm a PhD candidate at the University of Massachusetts Amherst, where my research explores how large language models can be used to understand an support student learning. My work bridges natural language processing, intelligent tutoring systems, and scalable student support. I explore the capabilities of LLMs for applications in education technologies and explore the impact of these technologies in the classroom by analyzing student behavior and their influence on learning outcomes. You can explore my work <Link href="https://scholar.google.com/citations?user=ucPEkvoAAAAJ">here</Link>.<br/><br/></Typography>
