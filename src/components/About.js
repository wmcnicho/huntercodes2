            ...
            <Box pt={12}>
                <Grid container spacing={2} p={3}>
                    ...
                    <Grid item md={7} xs={12} sx={{textAlign:'left'}}>
                        ...
                        <Typography> One year later, I started teaching a course on teach Artificial Intelligence at City College of New York. I love to teach and <Link href="https://www.ratemyprofessors.com/ShowRatings.jsp?tid=2689331">some of my students like it too</Link>! If you are a prospective student you can take a gander at the <Link>syllabus</Link> and <Link href="https://hmcnich.gitbook.io/csc448-f21/">assignments</Link> from a previous semester.<br/><br/></Typography>
                        <Typography>Teaching has reignited my passion for computer science, and I am now aspiring to go back into academics and contribute to the field through a PhD program. Inspired by my time working on Siri, my research interests broadly lie in natural language processing (NLP) and human-robot interaction. Within the field of NLP,  I am interested in natural language understanding, generative tasks and conversational modeling. Specifically, I am intrigued by how advancements in these areas can be leveraged to create more sophisticated chatbots and dialog systems.<br/><br/></Typography>
