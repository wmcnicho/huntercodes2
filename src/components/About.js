            ...
            <Box pt={12}>
                <Grid container spacing={2} p={3}>
                    ...
                    <Grid item md={7} xs={12} sx={{textAlign:'left'}}>
                        ...
                        <Typography>I'm a PhD candidate at the University of Massachusetts Amherst, where my research explores how large language models can be used to understand and support student learning. My work bridges natural language processing, intelligent tutoring systems, and scalable student support. I explore the capabilities of LLMs for applications in education technologies and explore the impact of these technologies in the classroom by analyzing student behavior and its influence on learning outcomes. You can explore my work <Link href="https://scholar.google.com/citations?user=ucPEkvoAAAAJ">here</Link>.<br/><br/></Typography>
                        ...
                        <Typography>Before pursuing my PhD, I worked as a software engineer at Apple on the Siri team, where I co-developed a distributed platform for a large-scale natural language processing system. I also founded HunterCodes, a freelance web development business focused on building web platforms and prototypes for small businesses and startups.<br/><br/></Typography>
