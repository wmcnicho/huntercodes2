            ...
            <Box pt={12}>
                <Grid container spacing={2} p={3}>
                    ...
                    <Grid item md={7} xs={12} sx={{textAlign:'left'}}>
                        ...
                        <Typography>I have been obsessed with computers and technology for longer than my working memory. This vice led me to pursue a joint bachelor-master degree in Computer Science at University of Southern California ✌️.<br/><br/></Typography>
                        <Typography>After graduating, I worked at Apple as a software engineer on Siri. I was on a cross-platform team where I developed server-side frameworks, mobile frameworks, and just about everything in between. A very scary stack of NDAs make this experience hard describe in detail, but I can say that I have become intimately familiar with <Link href="https://nlp.stanford.edu/acvogel/gus.pdf">GUS architectures</Link> and the challenges in building these systems at scale.<br/><br/></Typography>
                        <Typography>In 2019, I relocated from the Bay Area to New York where I continue to get lost in the subway systems and remind myself what seasons are. Here I started HunterCodes where I have worked with small businesses and startups to bring their ideas online. I mostly do web related builds so you could call me a full-stack engineer but I work in offline environments as well.<br/><br/></Typography>
                        <Typography>One year later, I started teaching a course on teach Artificial Intelligence at City College of New York. I love to teach (<Link href="https://www.ratemyprofessors.com/ShowRatings.jsp?tid=2689331">some of my students like it too</Link>). If you are a prospective student you can take a gander at the <Link>syllabus</Link> and <Link href="https://hmcnich.gitbook.io/csc448-f21/">assignments</Link> from a previous semester. Teaching has reignited my passion for computer science, and I am now aspiring to go back into academics to get a PhD in Computer Science.<br/><br/></Typography>
