            ...
            <Box pt={12}>
                <Grid container spacing={2}>
                    ...
                    <Grid item md={8} xs={12} sx={{textAlign:'left'}}>
                        ...
                        <Typography>I have been a obssessed with computers and technology for longer than my working memory. This vice led me to pursue a join bachelor-master degree in Computer Science at University of Southern California ✌️. <br/><br/></Typography>
